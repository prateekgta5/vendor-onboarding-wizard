        ...
        <form>
            ...
            <div className="space-y-6">
              ...
              {watchRequiresWarehousing && (
                <div className="ml-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="warehouse_location">Warehouse Location Details</Label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="storage_volume">Storage Volume Required</Label>
                    <Input
                      id="storage_volume"
            ...
            <div className="space-y-6">
                  ...
                  render={({ field }) => (
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="current" className="font-normal">Current</Label>
                      </div>
                    </RadioGroup>
                  )}
                />
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="payment_terms_agreement" className="text-sm">
                    I agree to the payment terms of BaseCampMart, including the 30-day payment cycle after invoice verification *
                  </Label>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="payment_terms_satisfaction" className="text-sm">
                    I understand that payment is subject to customer satisfaction and verification *
                  </Label>
                </div>
          ...
          <div className={`form-section ${currentStep === 7 ? "visible" : "hidden"}`}>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-2 mb-4">
                ...
                />
                <Label htmlFor="branding_offer">Would you like to offer cross-listing of your products on BaseCampMart's marketplace?</Label>
              </div>
              ...
              {watchBrandingOffer && (
                <div className="ml-6 space-y-4">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="cross_listing_permission">
                      I give permission for BaseCampMart to list my products on their marketplace
                    </Label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="cross_listing_agreement">
                      I agree to the commission structure of 10% for all sales through the marketplace
                    </Label>
                  </div>
                </div>
              )}
              ...
              <div className="space-y-2">
                <Label htmlFor="agreement_terms">Terms & Conditions *</Label>
                <Textarea
                  id="agreement_terms"
          ...
          <div className="flex justify-between mt-8 pt-4 border-t border-gray-200">
            <Button
              ...
              className="bg-transparent text-basecamp-primary hover:bg-basecamp-primary/10 border-basecamp-primary"
